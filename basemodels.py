...
def main():
    ...
    (x_train0, y_train0), (x_val0, y_val0), (x_te0, y_test0) = loader1.get_train_val_test("./Datasets/spectrogram_augment_2.csv")
    (x_train1, y_train1), (x_val1, y_val1), (x_te1, y_test1) = loader1.get_train_val_test("./Datasets/spectrogram_augment_3.csv")
    (x_train2, y_train2), (x_val2, y_val2), (x_te2, y_test2) = loader1.get_train_val_test("./Datasets/spectrogram_augment_4.csv")
    (x_train3, y_train3), (x_val3, y_val3), (x_te3, y_test3) = loader1.get_train_val_test("./Datasets/spectrogram_augment_5.csv")
